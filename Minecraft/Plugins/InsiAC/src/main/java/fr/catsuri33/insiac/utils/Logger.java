...
public class Logger {
    ...
    public static void success(String message){
        ...
        System.out.println(ConsoleColors.ANSI_GREEN + "[ " + date.format(actualDate) + " ]" + "[ InsiAC ] " + message + ConsoleColors.ANSI_WHITE);
    ...
    public static void info(String message){
        ...
        System.out.println(ConsoleColors.ANSI_BLUE + "[ " + date.format(actualDate) + " ]" + "[ InsiAC ] " + message + ConsoleColors.ANSI_WHITE);
    ...
    public static void warn(String message){
        ...
        System.out.println(ConsoleColors.ANSI_YELLOW + "[ " + date.format(actualDate) + " ]" + "[ InsiAC ] " + message + ConsoleColors.ANSI_WHITE);
    ...
    public static void error(String message){
        ...
        System.out.println(ConsoleColors.ANSI_RED + "[ " + date.format(actualDate) + " ]" + "[ InsiAC ] " + message + ConsoleColors.ANSI_WHITE);
