package com.insignicnetwork.practice.mysql;

import com.insignicnetwork.practice.Practice;
    ...
    public void connect(){
        ...
        if(!isConnected()){
            ...
            try{
                ...
                Practice.getInstance().log(ChatColor.GREEN + "Connected to the database !");
                return;
    ...
    public void disconnect(){
        ...
        if(isConnected()){
            ...
            try{
                ...
                connection.close();
                Practice.getInstance().log(ChatColor.RED + "Disconnected from the database !");
                return;
