...
public class Logger {
    ...
    public static void success(String message){
        ...
        System.out.println(ConsoleColors.ANSI_GREEN + "[InsignicNetworkLobby] " + message + ConsoleColors.ANSI_WHITE);
    ...
    public static void info(String message){
        ...
        System.out.println(ConsoleColors.ANSI_BLUE + "[InsignicNetworkLobby] " + message + ConsoleColors.ANSI_WHITE);
    ...
    public static void warn(String message){
        ...
        System.out.println(ConsoleColors.ANSI_YELLOW + "[InsignicNetworkLobby] " + message + ConsoleColors.ANSI_WHITE);
    ...
    public static void error(String message){
        ...
        System.out.println(ConsoleColors.ANSI_RED + "[InsignicNetworkLobby] " + message + ConsoleColors.ANSI_WHITE);
