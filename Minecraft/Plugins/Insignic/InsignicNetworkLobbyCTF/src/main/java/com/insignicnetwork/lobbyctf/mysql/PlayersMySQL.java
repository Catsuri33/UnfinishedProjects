package com.insignicnetwork.lobbyctf.mysql;

import com.insignicnetwork.lobbyctf.LobbyCTF;
    ...
    public void connect(){
        ...
        if(!isConnected()){
            ...
            try{
                ...
                LobbyCTF.getInstance().log(ChatColor.GREEN + "Connected to the database !");
                return;
    ...
    public void disconnect(){
        ...
        if(isConnected()){
            ...
            try{
                ...
                connection.close();
                LobbyCTF.getInstance().log(ChatColor.RED + "Disconnected from the database !");
                return;
