package com.insignicnetwork.goldenrush.mysql;

import com.insignicnetwork.goldenrush.GoldenRush;
import com.insignicnetwork.goldenrush.mysql.ranks.RanksList;
    ...
    public void connect(){
        ...
        if(!isConnected()){
            ...
            try{
                ...
                GoldenRush.getInstance().log(ChatColor.GREEN + "Connected to the database !");
                return;
    ...
    public void disconnect(){
        ...
        if(isConnected()){
            ...
            try{
                ...
                connection.close();
                GoldenRush.getInstance().log(ChatColor.RED + "Disconnected from the database !");
                return;
