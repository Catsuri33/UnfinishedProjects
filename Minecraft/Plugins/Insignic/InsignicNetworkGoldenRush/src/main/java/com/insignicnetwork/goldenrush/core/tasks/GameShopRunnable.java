...
public class GameShopRunnable extends BukkitRunnable {
    ...
    public void run() {
        ...
        if((timer == 300) || (timer == 240) || (timer == 180) || (timer == 120) || (timer == 60) || (timer == 30) || (timer == 10) || (timer == 5) || (timer == 4) || (timer == 3) || (timer == 2) || (timer == 1)){
            ...
            for(Player players : Bukkit.getOnlinePlayers()){
                ...
                players.sendMessage(GoldenRush.instance.prefix + "§eLa phase d'achats se termine dans §c" + timer + " " + getSecond(timer) + " §e!");
        ...
        if(timer == 0){
            ...
            for(Player players : Bukkit.getOnlinePlayers()){
                ...
                new GameManager().loadPvp(players);

            }

            new GamePvPRunnable().runTaskTimer(GoldenRush.instance, 0L, 20L);
