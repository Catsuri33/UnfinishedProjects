...
public class BorderDamageInventory {

    public static Inventory inv;

    public static void createInventory() {

        inv = Bukkit.createInventory(null, 27, "§8Dégâts de la Bordure");
