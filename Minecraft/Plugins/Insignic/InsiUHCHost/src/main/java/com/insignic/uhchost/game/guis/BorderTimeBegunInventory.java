...
public class BorderTimeBegunInventory {

    public static Inventory inv;
    public static long timeBorderBegun = 3600;

    public static void createInventory() {

        inv = Bukkit.createInventory(null, 27, "§8Temps avant Mouvement Bordure");
        ...
        lore.clear();
        lore.add("§7» Temps: §e" + timeBorderBegun / 60 + "min");
        im.setLore(lore);
        is.setItemMeta(im);
