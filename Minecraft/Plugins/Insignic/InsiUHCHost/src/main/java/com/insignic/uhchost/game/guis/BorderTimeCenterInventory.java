...
public class BorderTimeCenterInventory {

    public static Inventory inv;
    public static long timeBorderCenter = 1800;

    public static void createInventory() {

        inv = Bukkit.createInventory(null, 27, "§8Temps avant Bordure au Centre");
        ...
        lore.clear();
        lore.add("§7» Temps: §e" + timeBorderCenter / 60 + "min");
        im.setLore(lore);
        is.setItemMeta(im);
