...
public class BorderSizeEndInventory {

    public static Inventory inv;
    public static double borderEnd = 50;

    public static void createInventory() {

        inv = Bukkit.createInventory(null, 27, "§8Taille de la Bordure de Fin");
