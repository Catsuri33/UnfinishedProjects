package fr.catsuri33.uhc.listeners.legacypvp.armors;
...
public class Armor {
    ...
    static {
        ...
        GOLD_HELMET = new Armor(Material.GOLDEN_HELMET, 2);
        GOLD_CHESTPLATE = new Armor(Material.GOLDEN_CHESTPLATE, 5);
        GOLD_LEGGINGS = new Armor(Material.GOLDEN_LEGGINGS, 3);
        GOLD_BOOTS = new Armor(Material.GOLDEN_BOOTS, 1);
