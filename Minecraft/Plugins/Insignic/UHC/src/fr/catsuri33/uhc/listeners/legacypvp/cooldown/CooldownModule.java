package fr.catsuri33.uhc.listeners.legacypvp.cooldown;
...
public class CooldownModule implements Listener
{
    ...
    public CooldownModule()
    {
        ...
        data[Material.WOODEN_AXE.ordinal()] = 1;
        data[Material.GOLDEN_AXE.ordinal()] = 2;
        data[Material.WOODEN_SWORD.ordinal()] = 3;
        data[Material.GOLDEN_SWORD.ordinal()] = 4;
