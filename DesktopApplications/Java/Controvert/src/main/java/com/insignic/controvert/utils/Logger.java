package com.insignic.controvert.utils;
...
public class Logger {
    ...
    public static void info(String message){
        ...
        System.out.println(ConsoleColors.blue + "[" + formattedDate + "]" + "[Controvert]" + " " + message);
    ...
    public static void error(String message){
        ...
        localDate = LocalDateTime.now();
        formattedDate = localDate.format(dateFormat);
        System.out.println(ConsoleColors.red + "[" + formattedDate + "]" + "[Controvert]" + " " + message);
