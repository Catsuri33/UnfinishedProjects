package com.insignicstudio.test3dgame.utils;
...
public class Logger {
    ...
    public static void success(String message){
        ...
        System.out.println(ConsoleColors.ANSI_GREEN + "[ " + dateFormat.format(date) + " ]" + "[ Test3DGame ] " + message + ConsoleColors.ANSI_WHITE);
    ...
    public static void info(String message){
        ...
        System.out.println(ConsoleColors.ANSI_BLUE + "[ " + dateFormat.format(date) + " ]" + "[ Test3DGame ] " + message + ConsoleColors.ANSI_WHITE);
    ...
    public static void warn(String message){
        ...
        System.out.println(ConsoleColors.ANSI_YELLOW + "[ " + dateFormat.format(date) + " ]" + "[ Test3DGame ] " + message + ConsoleColors.ANSI_WHITE);
    ...
    public static void error(String message){
        ...
        System.out.println(ConsoleColors.ANSI_RED + "[ " + dateFormat.format(date) + " ]" + "[ Test3DGame ] " + message + ConsoleColors.ANSI_WHITE);
